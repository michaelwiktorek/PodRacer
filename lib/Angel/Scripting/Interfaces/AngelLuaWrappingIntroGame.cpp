...
#define SWIGTYPE_p_SwigTest swig_types[29]
...
static int _wrap_Message_GetSender(lua_State* L) {
  ...
  result = (MessageListener *)(arg1)->GetSender();
  {
    ...
    /*@SWIG:../../Angel/Libraries/swig/angelSwig/swiglib/typemaps/swigmacros.swg,192,%_formacro_1@*//*@SWIG:../../Angel/Libraries/swig/angelSwig/swiglib/lua/factory.i,7,%_factory_dispatch@*/ 
    if (!dcast) {
      SwigTest *dobj = dynamic_cast<SwigTest *>(result);
      if (dobj) {
        dcast = 1;
        SWIG_NewPointerObj(L, dobj, SWIGTYPE_p_SwigTest, 0); SWIG_arg++;
      }   
    }/*@SWIG@*/
...
static int _wrap_new_Actor(lua_State* L) {
  ...
  result = (Actor *)new Actor();
  {
    ...
    if (!dcast) {
      ...
      if (dobj) {
        dcast = 1;
        SWIG_NewPointerObj(L, dobj, SWIGTYPE_p_SwigTest, 1); SWIG_arg++;
      }   
    }/*@SWIG@*/
...
static int _wrap_new_SwigTest(lua_State* L) {
  int SWIG_arg = 0;
  SwigTest *result = 0 ;
  
  SWIG_check_num_args("SwigTest::SwigTest",0,0)
  result = (SwigTest *)new SwigTest();
  SWIG_NewPointerObj(L,result,SWIGTYPE_p_SwigTest,1); SWIG_arg++; 
  return SWIG_arg;
...
static void swig_delete_SwigTest(void *obj) {
SwigTest *arg1 = (SwigTest *) obj;
delete arg1;
}
static swig_lua_method swig_SwigTest_methods[] = {
    {0,0}
};
static swig_lua_attribute swig_SwigTest_attributes[] = {
    {0,0,0}
};
static swig_lua_attribute swig_SwigTest_cls_attributes[] = {
    {0,0,0}
};
static swig_lua_method swig_SwigTest_cls_methods[] = {
    {0,0}
};
static swig_lua_const_info swig_SwigTest_cls_constants[] = {
    {0,0,0,0,0,0}
};
static swig_lua_class *swig_SwigTest_bases[] = {0,0};
static const char *swig_SwigTest_base_names[] = {"Actor *",0};
static swig_lua_class _wrap_class_SwigTest = { "SwigTest", &SWIGTYPE_p_SwigTest,_wrap_new_SwigTest, swig_delete_SwigTest, swig_SwigTest_methods, swig_SwigTest_attributes, { "SwigTest", swig_SwigTest_cls_methods, swig_SwigTest_cls_attributes, swig_SwigTest_cls_constants }, swig_SwigTest_bases, swig_SwigTest_base_names };
...
static void *_p_SwigTestTo_p_Renderable(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((Renderable *) (Actor *) ((SwigTest *) x));
}
...
static void *_p_SwigTestTo_p_Actor(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((Actor *)  ((SwigTest *) x));
}
...
static void *_p_SwigTestTo_p_MessageListener(void *x, int *SWIGUNUSEDPARM(newmemory)) {
    return (void *)((MessageListener *) (Actor *) ((SwigTest *) x));
}
...
static swig_type_info _swigt__p_SwigTest = {"_p_SwigTest", "SwigTest *", 0, 0, (void*)&_wrap_class_SwigTest, 0};
